...
public:
    Karateka(int i) { 
        ...
        this->opponent = NULL;
        this->speed = 1;
        this->karatekaState->movement = "stand_up";
    }
...
public:
    ...
    string punch(string option) { 
        ...
        if (option == "oi-zuki" && random_number == 2) {
            this->karatekaState->movement = "oi-zuki";
            return "oi-zuki";
        } else if (option == "gyaku-zuki" && random_number == 4) {
            this->karatekaState->movement = "gyaku-zuki";
            return "gyaku-zuki";
        } else {
            return "fail";
        }
    ...
    string kick(string option){
        ...
        if (option == "mae-geri" && random_number == 2) {
            this->karatekaState->movement = "mae-geri";
            return "mae-geri";
        } else if (option == "yoko-geri" && random_number == 4) {
            this->karatekaState->movement = "yoko-geri";
            return "yoko-geri";
        } else {
            return "fail";
        }
    ...
    string block(){
        ...
        */
        ...
        this->karatekaState->movement = "block";
